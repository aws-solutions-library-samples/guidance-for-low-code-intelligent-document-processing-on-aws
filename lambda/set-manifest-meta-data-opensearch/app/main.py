...
def lambda_handler(event, _):
    """sets meta-data to be used by the OpenSearchBulk-file generator to set metadata for the search index
    Sample implementation. The OpenSearchBulk-file generator requires ORIGIN_FILE_NAME, START_PAGE_NUMBER
    Anything else added it just passed through down to the index
    """
