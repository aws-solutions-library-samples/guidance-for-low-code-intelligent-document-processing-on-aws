...
class PdfMapperToFhirWorkflow(Stack):
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        super().__init__(
            scope,
            construct_id,
            description="IDP CDK constructs sample for Amazon HealthLake integration (SO9217)",
            **kwargs,
        )
        ...
        healthlake_resource = healthlake.CfnFHIRDatastore(
            self, "HealthlakeDB", datastore_name="CDocs", datastore_type_version="R4"
        )
