...
class DemoQueries(Stack):
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        number_queries_and_pages_choice = (
            sfn.Choice(self, "NumberQueriesAndPagesChoice")
            .when(
                sfn.Condition.or_(
                    sfn.Condition.and_(
            ...
            .when(
                ...
                sfn.Fail(
                    self,
                    "TooManyQueriesOrPages",
                    error="TooManyQueriesOrPages",
                    cause="Too many queries > 30 or too many Pages > 3000. See https://docs.aws.amazon.com/textract/latest/dg/limits.html",  # noqa: E501
                ),
            )
        ...
        workflow_chain = sfn.Chain.start(decider_task).next(
            number_queries_and_pages_choice
        )
        # GENERIC
